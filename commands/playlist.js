    ...
    run: async function (client, message, args) {
        ...
        if (url.match(/^https?:\/\/(www.youtube.com|youtube.com)\/playlist(.*)$/)) {
            ...
            try {
                ...
                let thing = new MessageEmbed()
                    .setAuthor("Playlist has been added to queue", "https://cdn.discordapp.com/avatars/584723604181221396/d9793fc78946dc259170dd17869266ea.webp")
        ...
        async function handleVideo(video, message, channel, playlist = false) {
            ...
            if (!serverQueue) {
                ...
                if (playlist) return;
                let thing = new MessageEmbed()
                    .setAuthor("Song has been added to queue", "https://cdn.discordapp.com/avatars/584723604181221396/d9793fc78946dc259170dd17869266ea.webp")
        ...
        async function play(guild, song) {
            ...
            let thing = new MessageEmbed()
                .setAuthor("Started Playing Music!", "https://cdn.discordapp.com/avatars/584723604181221396/d9793fc78946dc259170dd17869266ea.webp")
                .setThumbnail(song.img)
                .setColor("BLUE")
                .addField("Name", song.title, true)
                .addField("Duration", song.duration, true)
